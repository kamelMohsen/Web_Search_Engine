...
public class Scraper {
    ...
    public void scrape(CrawlerDatabaseManager DB, String url, Map<String, Vector<String>> forbiddenList, Map<String, Vector<String>> allowedList) {
        try {
    ...
    public void Rescrape(CrawlerDatabaseManager DB, String url) {
